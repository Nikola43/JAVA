...
public class AvionPapel2 implements Cloneable, Comparable<AvionPapel2>, IVolador
{
    ...
    public AvionPapel2(AvionPapel2 avionPapel ) {
        this.ancho = avionPapel.ancho;
        this.largo = avionPapel.largo;
    }
    ...
    */
    ...
    public int compareTo(AvionPapel2 avionPapel2)
    {
        ...
        if ( avionPapel2 != null )
        {
            if ( ((ancho + largo) < (avionPapel2.ancho + avionPapel2.largo)) ) {
                resultadoComparacion = -1; //Menor
            }
            else if ( ((ancho + largo) > (avionPapel2.ancho + avionPapel2.largo)) ) {
    ...
    */
    ...
    public boolean equals(Object object)
    {
        ...
        if (object != null && object instanceof AvionPapel2)
        {
            ...
            if ( (ancho == avionPapel2.ancho) && (largo == avionPapel2.largo) )
                esIgual = true;
        }
        return esIgual;
    }
