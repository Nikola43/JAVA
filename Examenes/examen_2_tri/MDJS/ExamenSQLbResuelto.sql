...
INSERT INTO DEPARTAMENTOS
	SELECT 900, DIRECTOR_DE, DEPTJEFE_DE, CENTRO_DE, 'Ingenieria de sistemas', 3*SUM(SALARIO_EM), TIPODIR_DE
...
SELECT COD_EM, NOMB_EM, NOMB_DE, SALARIO_EM, POBLAC_CE
 ...
 SELECT * FROM V_DIRECTORES;--SALE TODA LA TABLACREADA CON VIEW
************************************************************************
